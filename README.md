...
## and now?
It has inserted a (dummy for now (it has a timestamp in it)) api key for ya! Along with a proxy to have CORS working good, and some preconfigured models (so no expensive ones are used). 
